...
% Sensing time for Hybrid model
T_sensing = T_d + (3 * T_p) + (T_m);
...
% sampling period is equal to delay / number of frames proccessed
h=(tau*2)/Y;
...
%Frames processed in one sampling period
gamma = Y/2;
